...
class BlobEnv():
    ...
    def reset(self):
        ...
        observation =  ([ob1[0]] + [ob1[1]] + [ob2[0]] + [ob2[1]]+ [ob3[0]] + [ob3[1]] + [ob4[0]] + [ob4[1]] + [a1] + [a3] + [H] )
        self.episode_step = 0
    ...
    def step(self, action):
        ...
        new_observation_m = ([ob1[0]] + [ob1[1]] + [ob2[0]] + [ob2[1]]+ [ob3[0]] + [ob3[1]] + [ob4[0]] + [ob4[1]] + [a1] + [a3] + [H] )
        new_observation =  new_observation_m  
        
        if self.episode_step >= 300:
            
            SUM11.append(Average(self.SUM1[-50:])) 
            SUM22.append(Average(self.SUM2[-50:])) 
            SUM33.append(Average(self.SUM3[-50:])) 
            SUM44.append(Average(self.SUM4[-50:]))
            ...
            NEAT_x.append(average_sum_rate) 
            NEAT_y.append( average_sum_rate * 2 / ( P_T + UAV_CONSTANT_POWER) )
...
# load the winner
p_t = 50
with open(f'11 Winners/winner p={p_t}dBm-11-INPUTS', 'rb') as f:
    c = pickle.load(f)
...
with open(f"NEAT_x-EE-p={p_t}dBm.pickle", "wb") as f:
                      pickle.dump(NEAT_x, f)
        
with open(f"NEAT_y-EE-p={p_t}dBm.pickle", "wb") as f:
                      pickle.dump(NEAT_y, f)


plt.plot(NEAT_x, NEAT_y, label="NEAT", **marker_style)
